...
public class Code extends JFrame implements GLEventListener
{
	...
	private int mv_location, proj_location, tx_location, n_location;
	...
	private Point3D cameraLoc = new Point3D(0.0, 0.0, 4.0);
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		// load the torus normals into the second buffer
		gl.glBindBuffer(GL_ARRAY_BUFFER, vbo[1]);
