...
{	private GLCanvas myCanvas;
	...
	private graphicslib3D.Material thisMaterial = graphicslib3D.Material.SILVER;
	private PositionalLight currentLight = new PositionalLight();
	private Point3D lightLoc = new Point3D(-5.0f, 2.0f, 5.0f);
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		setupVertices();
		roofTex = loadTexture("castleroofNORMAL.JPG");
		textureID1 = roofTex.getTextureObject();
	}
