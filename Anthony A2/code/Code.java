...
//    private float cameraPitchAngle = 0;
   ...
   {	//GL4 gl = (GL4) drawable.getGL();
      ...
      mvStack.rotate(camera.getPanAngle(),0.0,1.0,0.0); // left right
      mvStack.rotate(camera.getPitchAngle(),1.0,0.0,0.0); // up down
      ...
      //----------------- cube planet 2
      mvStack.pushMatrix();
      // orbital speed = Math.sin(amt*3)
      mvStack.translate(Math.sin(amt*3)*4.0f*2.0f, 0.0f, Math.cos(amt*3)*4.0f*2.0f);
      mvStack.pushMatrix();
      ...
      // orbital speed = Math.sin(amt*2)
      mvStack.translate(0.0f, Math.sin(amt*2)*2.0f, Math.cos(amt*2)*2.0f);
      //mvStack.pushMatrix();
      // rate of rotation = (System.currentTimeMillis())/1.0
      mvStack.rotate((System.currentTimeMillis())/1.0,0.0,0.0,1.0); // rotate on Z axis
